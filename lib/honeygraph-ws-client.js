    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        this.ws.on('open', () => {
          ...
          console.log('[HoneygraphWS] Connected - Sending handshake...');
          ...
          console.log('[HoneygraphWS] Sending identify message:', JSON.stringify(identifyMsg));
          this.sendMessage(identifyMsg);
          ...
          console.log('[HoneygraphWS] Sending sync status:', JSON.stringify(syncMsg));
