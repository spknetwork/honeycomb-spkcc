...
const msaccount = ENV.msaccount || 'dlux-cc' //account controlled by community leaders
...
const CustomJsonProcessing = "NA"
const CustomOperationsProcessing = "NA"
const CustomAPI = "NA"
const CustomChron = "NA"

const featuresModel = {
  claim: {
    id: 'claim',
    msg: 'Claiming DLUX airdrop',
    auth: 'posting',
    type: "move",
    string: 'Claim',
    B: false,
