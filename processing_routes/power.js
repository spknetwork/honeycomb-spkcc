...
export const power_up = (json, from, active, pc) => {
...
export const power_grant = (json, from, active, pc) => {
    var amount = parseInt(json.amount),
        to = json.to,
    ...
    Promise.all([
        ...
        .then(mem => {
            let from_power = mem[0],
                ...
                down_to = mem[8],
                ops = [];
            if (amount < from_power && amount >= 0 && active && from != to) {
...
export const power_down = (json, from, active, pc) => {
